...
<head>
    ...
    <link rel="stylesheet" href="/app/assets/css/override-bootstrap.css">
    <link rel="stylesheet" href="<?= __DIR__ ?>/app/assets/css/style.css">
</head>
        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                <?php foreach ($mainMenu as $page => $titre) { ?>
                    <li class="nav-item">
                        <a href="<?= $page; ?>" class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) === $page ? 'active' : "" ?>"><?= $titre; ?></a>
                    </li>
                <?php } ?>
            </ul>
